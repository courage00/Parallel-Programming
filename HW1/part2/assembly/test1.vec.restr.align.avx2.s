...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	vmovaps	32(%rbx,%rcx), %ymm1
	vaddps	32(%r15,%rcx), %ymm1, %ymm1
	vaddps	(%r15,%rcx), %ymm0, %ymm0
	vmovaps	%ymm0, (%r14,%rcx)
	vmovaps	%ymm1, 32(%r14,%rcx)
	vmovaps	64(%rbx,%rcx), %ymm0
	vmovaps	96(%rbx,%rcx), %ymm1
	vaddps	96(%r15,%rcx), %ymm1, %ymm1
	vaddps	64(%r15,%rcx), %ymm0, %ymm0
	vmovaps	%ymm0, 64(%r14,%rcx)
	vmovaps	%ymm1, 96(%r14,%rcx)
	subq	$-128, %rcx
