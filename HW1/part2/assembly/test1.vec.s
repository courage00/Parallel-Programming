...
.LBB0_3:                                #   Parent Loop BB0_2 Depth=1
	...
	movaps	32(%rbx,%rcx), %xmm2
	movaps	48(%rbx,%rcx), %xmm3
	addps	(%r15,%rcx), %xmm0
	addps	16(%r15,%rcx), %xmm1
	addps	32(%r15,%rcx), %xmm2
	addps	48(%r15,%rcx), %xmm3
	movaps	%xmm3, 48(%r14,%rcx)
	movaps	%xmm2, 32(%r14,%rcx)
	movaps	%xmm1, 16(%r14,%rcx)
	movaps	%xmm0, (%r14,%rcx)
	movaps	112(%rbx,%rcx), %xmm0
	movaps	96(%rbx,%rcx), %xmm1
	movaps	80(%rbx,%rcx), %xmm2
	movaps	64(%rbx,%rcx), %xmm3
	addps	64(%r15,%rcx), %xmm3
	addps	80(%r15,%rcx), %xmm2
	addps	96(%r15,%rcx), %xmm1
	addps	112(%r15,%rcx), %xmm0
	movaps	%xmm0, 112(%r14,%rcx)
	movaps	%xmm1, 96(%r14,%rcx)
	movaps	%xmm2, 80(%r14,%rcx)
	movaps	%xmm3, 64(%r14,%rcx)
	subq	$-128, %rcx
